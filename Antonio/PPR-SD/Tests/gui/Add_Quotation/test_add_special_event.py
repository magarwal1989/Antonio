...
class Test_AddSpecialQuote(Testbase):
    

    @pytest.mark.SMOKE
    def test_add_special_event(self,special_event_quote_obj):
        cust_name = special_event_quote_obj.get_customer_name_data()
        list_quot_obj = special_event_quote_obj.add_construction_quote()
